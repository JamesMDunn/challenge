...
export interface Obligation {
    ...
    sortDeposits : ObligationCollateral[];
    sortBorrows : ObligationLiquidity[];
...
export const ObligationParser = (
  ...
  console.log("decoded", ObligationLayout.decode(buffer))
  const {
    version,
    lastUpdate,
    lendingMarket,
